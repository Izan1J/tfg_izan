...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/guarde.css')); ?>">
</head>
...
<body>
    <header>
        <div class="header__logo-box">
            <a href=""><img src="<?php echo e(asset('images/logo.png')); ?>" alt="logo" class="header__logo"></a>
        </div>
        <div class="header__burger-box">
            <img src="<?php echo e(asset('images/burger-menu.svg')); ?>" alt="" class="header__burger" onclick="openModal()"><!--La hamburguesa ya desplegara todas las opciones, pero para que veas el modal en la version de movil haz click en la hamburguesa y saldra  -->
        </div>
        <nav class="header__nav">
            ...
            <?php if(Route::has('login')): ?>
                ...
                <a href="<?php echo e(route('register')); ?>" class="btn btn--blue">Registarse</a>
            <?php endif; ?>
        </nav>
    </header>
    ...
    <div id="register-modal" class="register-modal">
        ...
        <form class="register-modal__form" method="POST" action="<?php echo e(route('login')); ?>">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> register-modal__input" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus required />
...
unset($__errorArgs, $__bag); ?> register-modal__input" name="password" required autocomplete="current-password"/>
            ...
            <div class="grid">
                <div class="row">
                    <article class="features__article col-1-2">
                        <img src="<?php echo e(asset('images/comedor.jpg')); ?>" alt="" class="features__img">
                    ...
                    <article class="features__article col-1-2">
                        <img src="<?php echo e(asset('images/aula.webp')); ?>" alt="" class="features__img">
                        <div class="features__text-box">
                ...
                <article class="features__article">
                    <img src="<?php echo e(asset('images/senyo.jpg')); ?>" alt="" class="features__img">
                    <div class="features__text-box">
        ...
        <div class="footer__desktop row">
            <div class="footer__start col-1-4">
                <div class="footer__logo-box">
                    <img src="<?php echo e(asset('images/logo_letras.png')); ?>" alt="" class="footer__logo">
                </div>
            ...
            <div class="footer__redes col-1-4">
                <a href=""><img src="<?php echo e(asset('images/instagram.png')); ?>" alt="" class="redes__img"></a>
                <a href=""><img src="<?php echo e(asset('images/facebook.png')); ?>" alt="" class="redes__img"></a>
                <a href=""><img src="<?php echo e(asset('images/linkedin.png')); ?>" alt="" class="redes__img"></a>
            </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\tfg_izan\resources\views/welcome.blade.php ENDPATH**/ ?>