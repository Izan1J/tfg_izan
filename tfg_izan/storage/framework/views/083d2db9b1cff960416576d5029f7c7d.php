...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="domicilio" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Domicilio')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="domicilio" value="<?php echo e(old('domicilio')); ?>" required autocomplete="domicilio" autofocus>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="municipio" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Municipio')); ?></label>

                            <div class="col-md-6">
                                <input id="municipio" type="text" class="form-control <?php $__errorArgs = ['municipio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="municipio" value="<?php echo e(old('municipio')); ?>" required autocomplete="municipio" autofocus>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="telefono" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Telefono')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tfg_izan\resources\views\auth\register.blade.php ENDPATH**/ ?>